...
ax[0].plot(mean_timedata, label='PG', color='#de2d26', linewidth=2)
...
ax[1].plot(mean_rewardsdata, color='#de2d26', linewidth=2)
...
ax[0].plot(mean_timedata, label='LDPG (ours)', color='#006d2c', linewidth=2)
...
ax[1].plot(mean_rewardsdata, color='#006d2c', linewidth=2)
...
ax[0].plot(mean_timedata, label='Theoretical PG', color='#a50f15', linewidth=2)
...
ax[1].plot(mean_rewardsdata, color='#a50f15', linewidth=2)
...
ax[0].plot(mean_timedata, label='Theoretical LDG', color='#00441b', linewidth=2)
...
ax[1].plot(mean_rewardsdata, color='#00441b', linewidth=2)
...
ax[0].set_ylim(-25, 200)
ax[1].set_ylim(-800, 125)
